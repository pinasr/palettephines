...
## Overview
In spatial analysis, abstract color gradients (like `viridis` in R) are essential for perceptual clarity but often fail to provide immediate meaning to the local farmers, fisherfolks, etc. This package was developed not by teaching the locals how to read statistics, but by teaching vizualization how to speak their language.
