...
## Overview
In spatial analysis, abstract color gradients (like `viridis` in R) are essential for perceptual clarity but often fail to provide immediate meaning to the locals. This package was developed for data visualization to resonate with the lived experience of Filipino fishermen, farmers, and other local audience through anchoring it to scales such as plant phenology (BBCH-scale) and marine health (Reef Health Index).
