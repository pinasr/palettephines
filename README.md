<img src="man/figures/package_logo.png" align="right" height= "150"/>
...
## Overview
In spatial analysis, abstract color gradients (like `viridis` in R) are essential for mathematical clarity but often fail to provide immediate meaning at the local, community level. This package was developed not by teaching the locals how to read statistics, but by teaching visualization how to speak their language - through anchoring the scales to the natural colors of terrestrial and marine life.
